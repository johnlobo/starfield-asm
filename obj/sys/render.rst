...
Hexadecimal [16-Bits]
                              ...
                              4 
   0212                       5 palette:
   0212 14 0A 0A 0A           6 .db HW_BLACK        , HW_BRIGHT_YELLOW  , HW_BRIGHT_YELLOW  , HW_BRIGHT_YELLOW
   0216 0B 0B 0B 0B           7 .db HW_BRIGHT_WHITE , HW_BRIGHT_WHITE   , HW_BRIGHT_WHITE   , HW_BRIGHT_WHITE
   021A 0B 0B 0B 0B           8 .db HW_BRIGHT_WHITE , HW_BRIGHT_WHITE   , HW_BRIGHT_WHITE   , HW_BRIGHT_WHITE
   021E 0B 0B 0B 0B           9 .db HW_BRIGHT_WHITE , HW_BRIGHT_WHITE   , HW_BRIGHT_WHITE   , HW_BRIGHT_WHITE
                             10 
                             11 ;;
                             12 ;; INIT 
                             13 ;;  Initialize video mode
                             14 ;;
   0222                      15 sys_render_init::
   0222 0E 00         [ 7]   16     ld c,#0
   0224 CD 87 02      [17]   17     call cpct_setVideoMode_asm
   0227 21 12 02      [10]   18     ld hl, #palette
   022A 11 10 00      [10]   19     ld de, #16
   022D CD 62 02      [17]   20     call cpct_setPalette_asm
   001E                      21     cpctm_setBorder_asm HW_BLACK
                              1    .radix h
   ...
   0230 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   0233 CD 75 02      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   0236 C9            [10]   22     ret
                             23 
                             24 ;;
                             25 ;; UPDATE
                             26 ;;  Renders an entity
                             27 ;; Input
                             28 ;;  IX: Entity to be rendered
                             29 ;;
   0237                      30 sys_render_update::
                             31     ;; HL = Pointer to previous render location
   0237 DD 5E 06      [19]   32     ld e, e_prevptr(ix)
   023A DD 56 07      [19]   33     ld d, e_prevptr+1(ix)
   023D EB            [ 4]   34     ex de, hl
                             35     ;; Check previous render location (nullptr = no previous render location)
   023E 7D            [ 4]   36     ld a, l
   023F B4            [ 4]   37     or h
   0240 28 02         [12]   38     jr z, _do_not_erase
   0242                      39 _erase_prev:
   0242 36 00         [10]   40     ld (hl),#0
   0244                      41 _do_not_erase:
                             42     ;; Check entity alive before drawing
   0244 DD 7E 00      [19]   43     ld a, e_type(ix)
   0247 E6 80         [ 7]   44     and #e_type_dead
   0249 C0            [11]   45     ret nz
                             46 
                             47 ;; Calculate new location
   024A 11 00 C0      [10]   48     ld de, #0xc000
   024D DD 4E 01      [19]   49     ld c, e_x(ix)
   0250 DD 46 02      [19]   50     ld b, e_y(ix)
   0253 CD CA 02      [17]   51     call cpct_getScreenPtr_asm
                             52 
...
Hexadecimal [16-Bits]
                             ...
                             53 ;; Draw pixel
   0256 DD 7E 05      [19]   54     ld a, e_color(ix)
   0259 77            [ 7]   55     ld (hl), a
                             56 
                             57 ;; Save new location to previous (for later erasing)
   025A EB            [ 4]   58     ex de, hl
   025B DD 73 06      [19]   59     ld e_prevptr(ix), e
   025E DD 72 07      [19]   60     ld e_prevptr+1(ix), d
   0261 C9            [10]   61     ret
