...
Hexadecimal [16-Bits]
                             ...
                             36 
                             37 ;;
                             38 ;; Making system calls clearer
                             39 ;;
                             40 .macro SysUpdate sysname
                             41    ld hl, #sys_'sysname'_update
                             42    call man_entity_forall
                             43 .endm
                             44 
                             45 ;;
                             46 ;; Simple Starfield
                             47 ;;
   0040                      48 starfield:
                             49    ;; INIT MANAGER AND RENDER
   0040 3E 02         [ 7]   50    ld a, #2
   0042 CD 59 01      [17]   51    call man_level_init
   0045 CD 22 02      [17]   52    call sys_render_init
                             53 
                             54 ;;
                             55 ;; MAIN LOOP
                             56 ;;
   0048                      57 _st_loop:
                             58    ;;Update Systems
   0008                      59    SysUpdate generator
   0048 21 00 02      [10]    1    ld hl, #sys_generator_update
   004B CD FF 00      [17]    2    call man_entity_forall
   000E                      60    SysUpdate physics
   004E 21 03 02      [10]    1    ld hl, #sys_physics_update
   0051 CD FF 00      [17]    2    call man_entity_forall
   0014                      61    SysUpdate render
   0054 21 37 02      [10]    1    ld hl, #sys_render_update
   0057 CD FF 00      [17]    2    call man_entity_forall
                             62    ;; Update Entity Manager
   005A CD 16 01      [17]   63    call man_entity_update
                             64    ;; Wait VSYNC and repeat
   005D CD 7F 02      [17]   65    call cpct_waitVSYNC_asm
   0060 18 E6         [12]   66    jr _st_loop
                             67 
                             68 ;;
                             69 ;; MAIN function. This is the entry point of the application.
                             70 ;;    _main:: global symbol is required for correctly compiling and linking
                             71 ;;
   0062                      72 _main::
                             73    ;; Disable firmware to prevent it from interfering with string drawing
   0062 CD B9 02      [17]   74    call cpct_disableFirmware_asm
   0065 18 D9         [12]   75    jr starfield
